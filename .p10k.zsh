# Generated by Powerlevel10k configuration wizard on 2023-06-05 at 14:59 PDT.
...
# solid, right frame, darkest-ornaments, compact, few icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_MODE=nerdfont-v3+powerline
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=3
  ...
  typeset -g POWERLEVEL9K_AWS_STAGING_FOREGROUND=3
