...
description: Use for research, discovery, and independent data gathering that should stay out of the main conversation. The agent returns raw, structured findings and context only, saves the detailed artifact under ~/research, and does not synthesize or decide unless explicitly asked.
