init:
	sudo apt install zsh curl i3 rofi peco openssh-server terminator fzf htop mc flameshot mosh vim cmake  python3-dev golang nodejs npm clang build-essential sc jq
